@php
    ...
    if (!function_exists('extractYoutubeId')) {
        function extractYoutubeId($url)
        {
            ...
            return Str::before($id, '?'); // added strip query parameters in order to make the extra parameters in the helper function readable format
        }
    }
@endphp
...
<section class="downloadManuals">
    <div class="godrejContainer">
        <div class="mainInner">
                            ...
                            <div class="manualCard">
                                <div class="cardImage">
                                    ...
                                    <div class="cardOverlay">
                                        ...
                                        {{-- Product Description (overlayed) --}}
                                        <div style="font-size: 14px; color: #fff; margin-top: 10px;">
                                            @php
                                                $isTruncated = strlen($selectedProduct->description) > 100;
                                            @endphp

                                            <span id="descText">
                                                {{ $isTruncated ? Str::limit($selectedProduct->description, 100, '...') : $selectedProduct->description }}
                                            </span>

                                            @if ($isTruncated)
                                                <a href="javascript:void(0);" id="toggleDesc"
                                                    style="color: #ffd700; margin-left: 5px;">Read More</a>
                                            @endif
                                        </div>
            ...
            @push('scripts')
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const fullDescription = @json($selectedProduct ? $selectedProduct->description : '');

                        if (toggleLink && descText) {
                            let isExpanded = false;

                            toggleLink.addEventListener('click', function() {
                                if (!isExpanded) {
                                    descText.textContent = fullDescription;
                                    toggleLink.textContent = 'Read Less';
                                    isExpanded = true;
                                } else {
                                    descText.textContent = fullDescription.substring(0, 100) + '...';
            ...
            <!-- Share Section (place this outside conditionals so it appears on every slug page) -->
            <div style="position: relative;">
                <div id="shareContainer" style="position: absolute; bottom: 20px; right: 20px; z-index: 999;">
                    <button id="shareBtn"
                        ...
                        <svg width="30" height="30" viewBox="0 0 51 51" fill="none"
                            ...
                            <path d="M31.7695 21.2274C33.3343 21.2274 34.6028 19.9514 34.6028 18.3774..."
                    ...
                    <div id="shareMenu"
                        ...
                        <a href="#" class="share-link" data-platform="whatsapp"
                            style="display: block; padding: 5px 10px; color: #25D366;">Share on WhatsApp</a>
                        <a href="#" class="share-link" data-platform="facebook"
                            style="display: block; padding: 5px 10px; color: #3b5998;">Share on Facebook</a>
                        <a href="#" class="share-link" data-platform="linkedin"
                            style="display: block; padding: 5px 10px; color: #0077b5;">Share on LinkedIn</a>
                        <a href="#" class="share-link" data-platform="twitter"
                            style="display: block; padding: 5px 10px; color: #1da1f2;">Share on Twitter</a>
                    </div>
                </div>
            </div>
                ...
                <div class="godrejContainer">
                    <div class="mainInner">
                        <div class="commonHeading">
                            ...
                            <p>Watch product videos to learn more about installation, usage tips, and maintenance
                                guidelines.
                                ...
                                <div class="videoCard">
                                    <div class="cardImage">
                                        <iframe width="560" height="315"
                                            src="https://www.youtube.com/embed/{{ extractYoutubeId($selectedProduct->videos[0]->video_link) }}"
                                            title="{{ $selectedProduct->videos[0]->title }}" frameborder="0"
                        ...
                        @else
                            ...
                            <div class="mobileSingleCard">
                                <div class="videoCard">
                                    <div class="cardImage">
                                        <iframe width="560" height="315"
                                            src="https://www.youtube.com/embed/UcPyyhoGrjU"
                                            title="Step-by-Step Installation Guide for product" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                    </div>
                                    <div class="cardContent">
                ...
                <div class="footerUpperSection">
                    <div class="godrejContainer">
                        <div class="footerUpperSectionInner">
                            <div class="logo">
                                <a href="https://www.godrejenterprises.com/">
                                    <img src="{{ asset('images/godrejLogo-white.svg') }}" alt="Godrej"
                                        width="94" height="24">
                                </a>
                ...
                <div class="godrejContainer">
                    <div class="footerInner">
                        <div class="footerCol">
                            <h4>For Consumer</h4>
                            <ul>
                                <li><a href="https://www.godrejenterprises.com/home-appliances">Home Appliances</a>
                                </li>
                                <li><a href="https://www.godrejenterprises.com/furniture">Furniture & Fittings</a></li>
                                <li><a href="https://www.godrejenterprises.com/locks-and-security">Locks & Security</a>
                                </li>
                        ...
                        <div class="footerCol">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.godrejenterprises.com/commercial-appliances">Commercial
                                        Appliances</a>
                                </li>
                                <li><a href="https://www.godrejenterprises.com/advanced-engineering">Advanced
                                        Engineering</a>
                                </li>
                                ...
                                <li><a href="https://www.godrejenterprises.com/furniture-and-fittings">Furniture &
                                        Fittings</a>
                                </li>
                        ...
                        <div class="footerCol">
                            <h4>Good & Green</h4>
                            <ul>
                                <li><a href="https://www.godrejenterprises.com/about-us/good-and-green">Our Goals</a>
                                </li>
                                <li><a
                                        href="https://static.godrejenterprises.com/CS_Rpolicy4_P20022531_9a0c553524.pdf">CSR
                                        Policy</a></li>
                                <li><a
                                ...
                                <li><a
                                        ...
                                        Action Plan</a></li>
                                <li><a
                                        href="https://static.godrejenterprises.com/sustainability_full_report_6211d33fdd.pdf">Sustainability
                                        Report</a></li>
                            </ul>
                        ...
                        <div class="footerCol">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.godrejenterprises.com/about-us/our-milestones">Our
                                        Milestones</a></li>
                                <li><a href="https://www.godrejenterprises.com/about-us/awards-and-recognition">Awards
                                        &
                                        Recognition</a></li>
                                <li><a href="https://www.godrejenterprises.com/about-us/our-foundations">Our
                                        Foundation</a>
                                </li>
                                <li><a href="https://www.godrejenterprises.com/about-us/our-directors">Our
                                        Directors</a></li>
                                <li><a
                                        href="https://www.godrejenterprises.com/about-us/policies-and-reports/corporate-policies">Corporate
                                        Policies</a></li>
                                <li><a href="https://www.godrejenterprises.com/legal/statutory-reports">Statutory
                                        Report</a>
                                </li>
                                <li><a href="https://archives.godrejenterprises.com/GodrejArchives/">Godrej
                                        Archives</a></li>
                        ...
                        <div class="footerCol">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.godrejenterprises.com/newsroom/press-releases">Press
                                        Releases</a></li>
                                <li><a href="https://www.godrejenterprises.com/newsroom/blog">Blog</a></li>
                                <li><a href="https://www.godrejenterprises.com/newsroom/media-assets">Media Assets</a>
                                </li>
                            </ul>
                        </div>
                        <div class="footerCol">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.godrejenterprises.com/contact-us#corporate-office">Corporate
                                        Office</a></li>
                                <li><a href="https://www.godrejenterprises.com/contact-us#sales-inquiries">Sales
                                        Inquiries</a>
                                </li>
                                <li><a href="https://www.godrejenterprises.com/contact-us#customer-care">Customer
                                        Care</a></li>
                                <li><a href="https://www.godrejenterprises.com/contact-us#media-contact">Media
                                        Contact</a></li>
                                ...
                                <li><a href="https://www.godrejenterprises.com/contact-us#registered-offices">Registered
                                        Offices</a></li>
                                <li><a href="https://www.godrejenterprises.com/contact-us#branch-addresses">Branch
                                        Address</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="godrejContainer">
                        <div class="footerBottomInner">
                            ...
                            <div class="footerLinks">
                                ...
                                <a href="https://www.godrejenterprises.com/legal/terms-and-conditions">Terms &
                                    Conditions</a>
                            </div>
                            <div class="socialLinks">
                                ...
                                <a href="https://x.com/GodrejEntGroup" aria-label="Twitter">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="1.35em"
